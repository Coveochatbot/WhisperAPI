...
namespace WhisperAPI.Models.MegaGenial
{
    public class ModuleDetector
    {
        private static readonly Dictionary<Module, string> _vocabularyByModule = new Dictionary<Module, string> {
            ...
            { Module.WireComplicated, "fils complique compliqué stripes coupé coupe couper étoile etoile lumiere lumière rouge bleu piles ports"},
            { Module.WireSequence, "coupé coupe couper fils premier deuxième troisième quatrième cinquième sixième septième septieme huitième huitieme neuvieme neuvième 123456789 deuxieme troisieme quatrieme cinquieme sixieme A B C a b c" },
            { Module.WireSimple, "3 trois 4 quatre 5 cinq 6 six couleurs fils simple premier deuxième troisième quatrième cinquième sixième deuxieme troisieme quatrieme cinquieme sixieme coupé coupe couper" },
